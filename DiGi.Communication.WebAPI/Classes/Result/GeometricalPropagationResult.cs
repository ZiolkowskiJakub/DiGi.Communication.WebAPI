...
namespace DiGi.Communication.WebAPI.Classes
{
    ...
    /// <para>AI-NOTE (ownership): once the propagation calculation itself migrates into <see cref="GeometricalPropagationModelController"/>, this type becomes that endpoint response and the consuming application proxies it unchanged.</para>
    /// </summary>
